...
export function DarkNavTab({
  ...
  return (
    <Link
      href={path}
      className={`flex h-10 items-center rounded-t-lg border border-b-0 border-gray-50 px-4 text-sm font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-950 
