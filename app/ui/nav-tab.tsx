...
export function LightNavTab({ name, path, active }: { name: string; path: string; active: boolean; }) {
  return (
    <Link
      href={path}
      className={`focus-visible:outline-black border border-black flex h-10 items-center rounded-t-lg px-4 text-sm font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 
