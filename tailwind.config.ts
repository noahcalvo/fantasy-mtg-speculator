  ...
  theme: {
    ...
    keyframes: {
      ...
      fly: {
        ...
        '20%': {
          transform: 'translateY(calc(560px - 80vw)) rotate(180deg) scale(.8)',
        },
        '25%': {
          transform: 'translateY(calc(590px - 80vw)) rotate(270deg) scale(.5)',
        },
        '30%': {
          transform: 'translateY(calc(560px - 80vw)) rotate(360deg) scale(.6)',
        },
