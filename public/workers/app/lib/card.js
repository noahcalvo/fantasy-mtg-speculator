      ...
      switch (_b.label) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            fetch(
              'https://api.scryfall.com/cards/search?q=is%3Afirstprint+'.concat(
                encodedName,
              ),
            ),
          ];
        ...
        case 6:
          ...
          return [
            2 /*return*/,
            {
              name: cardData.name,
              image: (
                (_a = cardData.image_uris) === null || _a === void 0
                  ? void 0
                  : _a.png
              )
        ...
        case 7:
          ...
          throw new Error(
            'Failed to fetch card for cardName:'.concat(data.rows[0].name),
          );
        case 8:
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          throw new Error(
            'Failed to fetch card for cardName:'.concat(cardName),
          );
        case 4:
          return [2 /*return*/];
      }
