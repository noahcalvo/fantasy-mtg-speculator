            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (data.rows.length > 1) {
                        throw new Error("Uh oh. Multiple leagues found for ".concat(userId));
                    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["SELECT participants, open FROM leaguesV3 WHERE league_id = ", ";"], ["SELECT participants, open FROM leaguesV3 WHERE league_id = ", ";"])), leagueId)];
                case 1:
                    ...
                    return [2 /*return*/];
                case 2: return [4 /*yield*/, sql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["UPDATE leaguesV3 SET participants = array_append(participants, ", ") WHERE league_id = ", ";"], ["UPDATE leaguesV3 SET participants = array_append(participants, ", ") WHERE league_id = ", ";"])), userId, leagueId)];
                case 3:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, sql(templateObject_6 || (templateObject_6 = __makeTemplateObject(["UPDATE leaguesV3 SET commissioners = array_append(commissioners, ", ") WHERE league_id = ", ";"], ["UPDATE leaguesV3 SET commissioners = array_append(commissioners, ", ") WHERE league_id = ", ";"])), userId, leagueId)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    ...
                    throw new Error("Failed to add commissioner ".concat(userId, " to league ").concat(leagueId));
                case 3: return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sql(templateObject_7 || (templateObject_7 = __makeTemplateObject(["INSERT INTO leaguesV3 (name, participants, commissioners, open) VALUES (", ", array[]::int[], array[]::int[], true) RETURNING league_id;"], ["INSERT INTO leaguesV3 (name, participants, commissioners, open) VALUES (", ", array[]::int[], array[]::int[], true) RETURNING league_id;"])), leagueName)];
                case 1:
                    resp =
                        _a.sent();
                ...
                case 3:
                    redirect("/league/".concat(resp === null || resp === void 0 ? void 0 : resp.rows[0].league_id, "/teams"));
                    return [7 /*endfinally*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    throw new Error("Failed to fetch players for leagueId ".concat(leagueId));
                case 3: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, sql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    SELECT participants FROM leaguesV3 WHERE league_id=", " LIMIT 1;"], ["\n    SELECT participants FROM leaguesV3 WHERE league_id=", " LIMIT 1;"])), leagueId)];
                case 1:
                    data = _a.sent();
