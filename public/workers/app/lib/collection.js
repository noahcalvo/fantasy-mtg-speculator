  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          result = _a.sent();
          convertedData = result.rows.map(function (row) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          data = _a.sent();
          cardIds = data.rows.map(function (row) {
            return row.value;
          });
        ...
        case 2:
          ...
          throw new Error(
            'Failed to fetch collection for player:'.concat(playerId),
          );
        case 3:
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 4:
          ...
          return [3 /*break*/, 2];
        case 5:
          return [2 /*return*/, cardDetailsList];
        case 6:
          error_3 = _d.sent();
          console.error('Database Error:', error_3);
          throw new Error(
            'Failed to fetch collection with card details for player:'.concat(
              playerId,
            ),
          );
        case 7:
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          data = _a.sent();
          convertedData = data.rows.map(function (row) {
            return __assign(__assign({}, row), {
              total_points: Number(row.total_points),
            });
          });
            ...
            sql(
              templateObject_4 ||
                (templateObject_4 = __makeTemplateObject(
                  ['SELECT league_id FROM draftsV4 WHERE draft_id = ', ''],
                  ['SELECT league_id FROM draftsV4 WHERE draft_id = ', ''],
                )),
              draftId,
            ),
            ...
            sql(
              templateObject_5 ||
                (templateObject_5 = __makeTemplateObject(
                  ['SELECT * FROM picksV5 WHERE draft_id = ', ''],
                  ['SELECT * FROM picksV5 WHERE draft_id = ', ''],
                )),
              draftId,
            ),
            ...
            sql(
              templateObject_6 ||
                (templateObject_6 = __makeTemplateObject(
                  [
                    'INSERT INTO ownershipV3 (player_id, card_id, league_id) VALUES (',
                    ', ',
                    ', ',
                    ');',
                  ],
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            fetchPlayerCollectionWithDetails(playerId, league_id),
          ];
        case 3:
        ...
        case 4:
          error_6 = _a.sent();
          console.error(
            'Failed to fetch details for playerId '
              .concat(playerId, ': ')
              .concat(error_6),
          );
        ...
        case 5:
          ...
          return [3 /*break*/, 1];
        case 6:
          return [2 /*return*/, playerCollections];
      }
    });
  });
}
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          error_7 = _a.sent();
          console.error(
            'Failed to check if player '
              .concat(playerId, ' owns ')
              .concat(cardIds),
            error_7,
          );
          throw new Error(
