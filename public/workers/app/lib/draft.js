...
export function createDraft(
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4 /*yield*/, isCommissioner(playerId, league_id)];
        case 1:
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'INSERT INTO draftsV4 (set, active, rounds, name, participants, league_id, auto_draft) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING draft_id;',
              [set, true, rounds, name, [], league_id, auto_draft],
            ),
          ];
        case 3:
          resp = _b.sent();
...
var fetchAllDrafts = function (leagueId) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            pool.query('SELECT * FROM draftsV4 WHERE league_id = $1;', [
              leagueId,
            ]),
          ];
        case 1:
...
var fetchDraftsBySet = function (leagueId, set) {
  return __awaiter(void 0, void 0, void 0, function () {
    var res, error_3;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
export var fetchDrafts = function (leagueId, set) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      if (set) {
...
export var fetchDraft = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
    var res, error_4;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
export var joinDraft = function (draftId, playerId) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'SELECT participants, active FROM draftsV4 WHERE draft_id = $1;',
              [draftId],
            ),
          ];
        case 1:
...
export var redirectIfJoined = function (participants, playerId, draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
    var shouldRedirect;
    return __generator(this, function (_a) {
...
var addPicks = function (draftId, playerId) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var snakePicks = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'UPDATE picksV5 SET pick_number = $1 WHERE draft_id = $2 AND round = $2 AND player_id = $4;',
...
export var fetchPicks = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
    var res, error_8;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            pool.query('SELECT * FROM picksV5 WHERE draft_id = $1;', [draftId]),
          ];
        case 1:
          res = _a.sent();
...
export var fetchAvailableCards = function (cards, draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            pool.query('SELECT * FROM picksV5 WHERE draft_id = $1);', [
              draftId,
            ]),
          ];
        case 1:
          ...
          undraftedCards = cards.filter(function (card) {
            return !res_1.rows.some(function (pick) {
              return pick.card_id === card.name;
            });
          });
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          activePick = _a.sent();
          if (
            (activePick === null || activePick === void 0
              ? void 0
              : activePick.player_id) !== playerId
          ) {
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'UPDATE draftsV4 SET last_pick_timestamp = NOW() WHERE draft_id = $1;',
              [draftId],
            ),
          ];
        case 5:
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'UPDATE draftsV4 SET active = false WHERE draft_id = '.concat(
                draftId,
                ';',
              ),
            ),
...
export var getOrCreateCard = function (cardName, set) {
  return __awaiter(void 0, void 0, void 0, function () {
    var frontSideName,
      existingCard,
      newCard_1,
      existingDoubleFaceCard,
      newCard,
      error_11;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            pool.query('UPDATE cards SET name = $1 WHERE card_id = $1;', [
              cardName,
...
var isDraftComplete = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
...
export var getActivePick = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
...
export var fetchMostValuableUndraftedCard = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
...
export var fetchUndrafterCards = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
    var draft,
      cards,
      alreadyOwnedCards_1,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 5:
          ...
          undraftedCards = cards.filter(function (card) {
            return (
              !draftedCardNames_1.includes(card.name) &&
              !alreadyOwnedCards_1.some(function (ownedCard) {
...
export var fetchAutoDraftTime = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'SELECT pick_time_seconds, auto_draft FROM draftsV4 WHERE draft_id = $1;',
              [draftId],
            ),
          ];
        case 1:
...
export var fetchDraftTimer = function (draftId) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            pool.query(
              'SELECT pick_time_seconds, auto_draft, last_pick_timestamp FROM draftsV4 WHERE draft_id = $1;',
              [draftId],
            ),
          ];
        case 1:
          ...
          last_pick_timestamp.setSeconds(
            last_pick_timestamp.getSeconds() + pick_time,
          );
